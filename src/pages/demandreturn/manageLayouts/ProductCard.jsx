                    ...
                    document.Positions.map((item, index) => {
                        return (
                            <ListItem
                                ...
                                onPress={() => {
                                    navigation.navigate('product-position', { product: item, state: document, setState: setDocument, type: 0, units: units, setUnits: setUnits, setHasUnsavedChanges: setHasUnsavedChanges, pricePermission: local.demands.demandReturn.positionModalPrice })
